          ...
          setTimeout(() => {
           ...
           if (activeGame && activeGame.gameId === gameId && Date.now() < activeGame.endTime) {
            ...
            const words = [
              ...
              { word: 'CLOUD', hint: 'White fluffy formation in the sky' },
              ...
              { word: 'LAUGH', hint: 'Express joy with sound' },
              { word: 'MAGIC', hint: 'Mysterious tricks and illusions' },
              { word: 'OCEAN', hint: 'Vast body of salt water' },
              { word: 'PEACE', hint: 'Freedom from war or conflict' },
              ...
              { word: 'CREATIVE', hint: 'Having the ability to make new things' },
              { word: 'DATABASE', hint: 'Organized collection of information' },
              { word: 'ELEPHANT', hint: 'Largest land mammal with a trunk' },
              { word: 'FESTIVAL', hint: 'Celebration or series of events' },
              { word: 'GRATEFUL', hint: 'Feeling thankful and appreciative' },
              { word: 'HARMONY', hint: 'Pleasant combination of sounds or elements' },
              { word: 'JOURNEY', hint: 'Act of traveling from one place to another' },
              { word: 'KEYBOARD', hint: 'Device with keys for typing' },
              { word: 'LAUGHTER', hint: 'Sound of laughing' },
              { word: 'MOUNTAIN', hint: 'Very high natural elevation' },
              { word: 'NAVIGATE', hint: 'Plan and direct a route or course' },
              { word: 'PARALLEL', hint: 'Two lines that never meet' },
              { word: 'QUESTION', hint: 'Sentence seeking information' },
              { word: 'RAINBOW', hint: 'Colorful arc in the sky after rain' },
              { word: 'SANDWICH', hint: 'Food between two slices of bread' },
              { word: 'TREASURE', hint: 'Valuable hidden items or wealth' },
              ...
              { word: 'WONDERFUL', hint: 'Inspiring delight or admiration' },
              
              // Hard words (10+ letters, complex spelling)
              ...
              { word: 'IDIOSYNCRASY', hint: 'A peculiar behavioral characteristic' },
              { word: 'SURREPTITIOUS', hint: 'Kept secret, especially if disapproved' },
              { word: 'UBIQUITOUS', hint: 'Present or found everywhere' },
              { word: 'VICARIOUS', hint: 'Experienced through another person' },
              { word: 'ONOMATOPOEIA', hint: 'Word formed from a sound it represents' },
              { word: 'PHENOMENON', hint: 'Observable fact or event' },
              { word: 'SYNECDOCHE', hint: 'Figure of speech using part for whole' },
              { word: 'WORCESTERSHIRE', hint: 'A savory condiment sauce' },
              { word: 'XYLOPHONE', hint: 'Percussion instrument with wooden bars' },
              { word: 'PERPENDICULAR', hint: 'At an angle of 90 degrees' },
              { word: 'SERENDIPITY', hint: 'Finding something good by accident' },
              { word: 'SILHOUETTE', hint: 'Dark outline against lighter background' },
              { word: 'KALEIDOSCOPE', hint: 'Tube with mirrors creating patterns' },
              { word: 'MISCHIEVOUS', hint: 'Playfully causing trouble' },
              { word: 'BUREAUCRACY', hint: 'Complex administrative system' },
              { word: 'UNNECESSARY', hint: 'Not needed or essential' },
              { word: 'PTERODACTYL', hint: 'Extinct flying reptile' },
              { word: 'SURVEILLANCE', hint: 'Close observation or monitoring' }
            ];
